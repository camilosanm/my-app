...
type sbResponse = User | Session | ApiError | null;
...
export class AuthService {
    ...
    async signIn(credentials: UserCredentials): Promise<sbResponse> {
        try {
    ...
    async signUp(credentials: UserCredentials): Promise<sbResponse> {
        try {
